export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx87b6d645ce81c6bf",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "a7474086c805d05e3e4148d415f75fee",
   ...
   */
  USERS: [ouqS45vjw6vk7Gg27ocU014vY7Qs,ouqS45vjw6vk7Gg27ocU014vY7Qs
    {
      // 想要发送的人的名字
      name: "串串0",
      ...
      id: "",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "9FosGpwfsO5dznQjQ5PdtRxeCGYENLEee4jVPPXQZYM",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "深圳",
